...
**Keywords:**
`Python` `NumPy` `Pandas` `Matplotlib` `Seaborn` `Análise Exploratória` `Visualização de Dados` `ETL`
...
**Keywords:**
`SQL` `Modelagem de Dados` `Bancos Relacionais` `Queries Analíticas`
...
**Keywords:**
`AWS` `Cloud Computing` `Docker` `CI/CD` `DevOps`
...
<p>
  <a href="https://linkedin.com/in/lucasomafra">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
  <a href="https://github.com/LucasOMafra">
